...
const Portfolio = () => {
  ...
  const { data: couplesData, loading, error } = useCouples();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {couples.map((couple) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl mb-4 aspect-[5/4]">
                <img
        ...
        {couples.length === 0 && (
          <div className="text-center">
            <p className="text-gray-600">No couples found.</p>
          </div>
        )}
